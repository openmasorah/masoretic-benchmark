...
lands. The realistic-chain mocked test in `test_baseline_unit_char_menaked_chain.py`
exercises the realistic-chain code path under unit tests; this live test
only adds value once a real per-line GT is available.
"""

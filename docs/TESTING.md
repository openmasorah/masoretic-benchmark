...
- `tests/test_manifest_hash_artifacts.py` — asserts that **no** result tree is
  published in v0.1 (git-tracked, not merely present on disk: a local baseline
...
`baselines/tests/fixtures/iaa_folio_leningrad_devarim_*`.
